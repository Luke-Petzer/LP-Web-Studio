...
export function ProjectOverview({
  ...
  return <section ref={overviewRef} className="mb-16">
      ...
      <div className="prose prose-lg max-w-none text-slate-300 animate-on-scroll opacity-0 space-y-6">
        ...
        {purpose && (
          <div className="bg-slate-900/40 backdrop-blur-sm border border-slate-800 rounded-xl p-6">
            ...
            <p className="text-base leading-relaxed text-slate-400">{purpose}</p>
          </div>
        )}
        ...
        {targetAudience && (
          <div className="bg-slate-900/40 backdrop-blur-sm border border-slate-800 rounded-xl p-6">
            ...
            <p className="text-base leading-relaxed text-slate-400">{targetAudience}</p>
          </div>
        )}
            ...
            <ul className="space-y-3 list-none pl-0">
              {keyFeatures.map((feature, index) => (
                <li key={index} className="flex items-start">
                  ...
                  <span className="text-base leading-relaxed text-slate-400">{feature}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        {scope && (
          <div className="bg-slate-900/40 backdrop-blur-sm border border-slate-800 rounded-xl p-6">
            ...
            <p className="text-base leading-relaxed text-slate-400">{scope}</p>
          </div>
        )}
      </div>
    </section>;
