    ...
    <section className="relative py-20 md:py-28 backdrop-blur-sm overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-slate-900 dark:text-slate-50 animate-fade-in transition-colors duration-300">
            Get In{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-400">
              Touch
            </span>
          </h1>
          <p className="text-xl text-slate-700 dark:text-slate-300 mb-8 leading-relaxed animate-fade-in transition-colors duration-300">
