      ...
      <div className="space-y-8">
        {challengesList.map((item, index) => (
          <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {/* Challenge Card */}
            <div className="bg-slate-50 border-l-4 border-amber-500 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-300 animate-on-scroll opacity-0">
            ...
            {/* Solution Card */}
            <div className="bg-slate-50 border-l-4 border-emerald-500 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow duration-300 animate-on-scroll opacity-0">
              <div className="flex items-start mb-4">
