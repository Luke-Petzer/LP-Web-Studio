  ...
  return <section ref={sectionRef} className="relative py-20 md:py-28 backdrop-blur-sm">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-8 text-slate-50 animate-fade-in">
            My{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-400">
              Approach
            </span>
          </h2>
          <p className="text-xl text-slate-300 mb-12 animate-fade-in leading-relaxed">
      ...
      <div className="container mx-auto px-4 md:px-6 mt-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-900/60 backdrop-blur-sm border border-slate-800 rounded-2xl shadow-xl p-8 md:p-10 hover:border-orange-500/50 transition-all duration-300">
            <h3 className="text-2xl font-bold mb-6 text-center text-slate-100 animate-fade-in">
              What You Can Expect
            </h3>
            <p className="text-lg text-slate-300 leading-relaxed text-center animate-fade-in">
...
function ApproachCard({
  ...
  return <div className="bg-slate-900/60 backdrop-blur-sm border border-slate-800 p-6 rounded-2xl shadow-lg hover:shadow-xl hover:border-orange-500/50 transition-all duration-300 transform hover:-translate-y-2">
      <div className="flex flex-col items-center">
        <div className="mb-4 p-4 bg-slate-800/80 border border-slate-700 rounded-2xl transform hover:scale-110 transition-transform duration-300">
          {icon}
        </div>
