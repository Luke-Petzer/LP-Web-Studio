          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="order-2 lg:order-1">
              <div className="relative max-w-sm mx-auto">
                <div className="absolute -top-6 -left-6 w-24 h-24 bg-orange-500/20 rounded-full blur-2xl hidden lg:block"></div>
                <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-teal-500/20 rounded-full blur-2xl hidden lg:block"></div>
                <div className="relative overflow-hidden rounded-full shadow-2xl border-4 border-slate-800">
                  <img
                    src="/Me1.JPG"
            ...
            <div className="order-1 lg:order-2">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-8 text-slate-50 animate-fade-in">
                About{' '}
              ...
              <div className="space-y-6 text-lg text-slate-300 leading-relaxed animate-fade-in">
                <p>
